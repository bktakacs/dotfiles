...
if [ "$1" = "$FOCUSED_WORKSPACE" ]; then
  sketchybar --set $NAME background.color=$MOONWHITE label.color=0xff000000 icon.color=0xff000000 background.border_color=0xffd61919 background.border_width=2
else
